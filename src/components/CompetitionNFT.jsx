...
function NFTBalance() {
  //const { data: NFTBalances } = useNFTBalances({address: "0x7D0719491fbc1D1D4f65b185a729756541c3b16f"});
  ...
  if (NFTBalances == null) {
    Moralis.Web3API.token.getAllTokenIds({address: "0x7D0719491fbc1D1D4f65b185a729756541c3b16f", chain: "ropsten" }).then(NFTs => {
