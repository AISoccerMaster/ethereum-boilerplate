...
function NFTBalance() {
  //const { data: NFTBalances } = useNFTBalances({address: "0x19F3fb33fE394A8B6c132E92DE3ff2157598678D", offset: 0, limit: 100});
  ...
  if (NFTBalances == null) {
    Moralis.Web3API.token.getAllTokenIds({address: "0x19F3fb33fE394A8B6c132E92DE3ff2157598678D", chain: "ropsten" }).then(NFTs => {
            ...
            NFTBalances.result.map((nft, index) => {
              ...
              return (
                <Card
                  ...
                  key={index}
                >
                  <Meta title={nft.name + "[" + nft.symbol + "]"} description={nft.token_address} />
                </Card>
              );
            })}
        </Skeleton>
